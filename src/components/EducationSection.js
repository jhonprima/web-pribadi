            ...
            <div className="education-card">
              ...
              <div className="education-header">
                ...
                <div className="flex-grow-1">
                  ...
                  <div className="education-meta">
                    ...
                    {edu.status && (
                      <span className="badge badge-ongoing">{edu.status}</span>
                    )}
                  </div>
                </div>
              </div>
              ...
              {edu.image && (
                <div className="education-main-image">
                  <img src= "./images/5.jpg" alt={edu.school} />
                  ...
                  <div className="d-flex justify-content-between align-items-center mb-3">
                    ...
                    <label className="btn-add-photo">
                      <input
                        type="file"
                        accept="image/*"
                        onChange={(e) => handleAddPhoto(e, edu.id)}
                        style={{ display: 'none' }}
                      />
                      <FaPlus size={14} />
                      <span>Add Photo</span>
                      ...
                      {edu.gallery.map((photo, idx) => (
                        <div key={idx} className="gallery-item">
                          ...
                          <button
                            ...
                            onClick={() => handleDeletePhoto(edu.id, idx)}
                          >
                            <FaTrash size={12} />
                          </button>
                        </div>
            ...
            <div className="modal-body">
              {selectedEdu.image && (
                <div className="education-detail-image mb-4">
                  <img src={selectedEdu.image} alt={selectedEdu.school} />
                </div>
              )}
